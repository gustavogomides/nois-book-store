                    ...
                    <div class="panel panel-default">
                        ...
                        <form ng-submit="AdminController.addLivro(livro)">
                                ...
                                <div class="form-group">
                                    <label>ISBN</label>
                                    <input type="text" class="form-control" ng-model="livro.isbn" required maxlength="15"placeholder="ISBN do Livro">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" fileread="livro.image" required name="pic" accept=".jpg, .jpeg" class="form-control" placeholder="Capa do Livro">
                                </div> 
